namespace BK_GUI
{
    partial class FrmOpretBruger
    {
        ...
        private void InitializeComponent()
        {
			...
			this.btnTilføjBruger.TabIndex = 11;
			...
			this.chkVegetar.CheckedChanged += new System.EventHandler(this.chkVegetar_CheckedChanged);
			// 
			// chkVeganer
			// 
			...
			this.chkVeganer.CheckedChanged += new System.EventHandler(this.chkVeganer_CheckedChanged);
			// 
			// label7
			// 
