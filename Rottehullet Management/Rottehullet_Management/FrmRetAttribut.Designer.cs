namespace Rottehullet_Management
{
	partial class FrmRetAttribut
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnSletValgmulighed.TabIndex = 7;
			...
			this.btnTilføjValgmulighed.TabIndex = 4;
			...
			this.txtValgmulighed.TabIndex = 3;
			// 
			// lstValgmuligheder
			// 
			...
			this.btnRetValgmulighed.TabIndex = 6;
